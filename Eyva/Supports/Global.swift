...
// Gradient
let pinkGradientBG = [
    UIColor(red: 0.718, green: 0.478, blue: 0.733, alpha: 0.7).cgColor,
    UIColor(red: 0.937, green: 0.678, blue: 0.788, alpha: 0.7).cgColor
]

let blueGradientBG = [
    UIColor(red: 0.337, green: 0.388, blue: 0.549, alpha: 0.7).cgColor,
    UIColor(red: 0.443, green: 0.71, blue: 0.827, alpha: 0.7).cgColor
]
